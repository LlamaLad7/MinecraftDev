...
import com.demonwav.mcdev.platform.mcp.ct.CtFile
...
class DuplicateAwEntryInspection : LocalInspectionTool() {
    ...
    override fun checkFile(file: PsiFile, manager: InspectionManager, isOnTheFly: Boolean): Array<ProblemDescriptor>? {
        ...
        val collected = HashMap<Pair<PsiElement, String>, MutableList<CtAwEntryMixin>>()
        file.entries.filterIsInstance<CtAwEntryMixin>().forEach {
            val target = it.childOfType<CtAwMemberNameMixin>()?.resolve()
